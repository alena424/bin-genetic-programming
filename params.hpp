...
UINT NUM_CONFIG = 5;     // number of random configuration that will be used to somlue fitness, space 2^cellular_length
UINT GENERATIONS = 30;   // number of generations
UINT POPSIZE = 10;       // size of population
...
public:
    ...
    GA_chromosome(UINT chromosome_length, bool empty)
    {
